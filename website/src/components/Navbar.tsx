      ...
      <nav className="max-w-7xl mx-auto">
        <div className="glass-nav rounded-full px-6 py-3 flex justify-between items-center transition-all duration-300">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            {/* User Avatar (when signed in) or Sign In button (when signed out) */}
            {account?.signedIn ? (
              ...
              <button
                ...
                disabled={authBusy}
                className="hidden sm:inline-flex px-3.5 py-1.5 text-xs font-medium text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer"
              >
